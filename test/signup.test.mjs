...
test('closed beta never exposes install link',async()=>{const{send}=await setup();assert.deepEqual(await(await send()).json(),{registered:true,ready:false,emailNotifications:false,playUrl:null})});
